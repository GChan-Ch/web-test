              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                ?>
                    ...
                    <tr>
                            ...
                            <td>
                                <a onclick="return confirm('hapus Data Ini ??')" href ="?page=inventaris&aksi=hapus&no=<?php echo $data['no'];?>" class="btn btn-danger" > <i class="glyphicon glyphicon-trash"></i> Hapus</a>
                                <a href ="" class="btn btn-info" > <i class="glyphicon glyphicon-print"></i> Print</a>
