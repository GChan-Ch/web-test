...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>GOLDEN<span>WEB</span></b></a>
      <!--logo end-->
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a href="?page=peminjaman">
              ...
              <li class="sub-menu">
            <a href="?page=peminjaman&aksi=konfirmasi">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>GAMER ABADI</h3>
        <div class="row mb">
          <!-- page start-->
          <?php
                        ...
                        if ($aksi == "") {
                          ...
                          if ($aksi == "") {
                              ...
                              if ($aksi == "") {
                                  ...
                                  include "page/peminjaman/konfirmasi.php";
                              }elseif ($aksi == "conn") {
                                  include "page/peminjaman/conn.php";
                                }
                                      ...
                                      if ($aksi == "") {
                                          ...
                                          if ($aksi == "") {
                                              ...
                                              if ($aksi == "") {
                                                  ...
                                                  include "page/instansi/tambah.php";
                                              }elseif ($aksi == "ubah") {
                                                  include "page/instansi/ubah.php";
                                              }elseif ($aksi == "hapus") {
                                                  include "page/instansi/hapus.php";
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Welcome<strong>To</strong>Goldi WEB
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created by GOLDI <a href="https://www.instagram.com/">goldifirmansyah</a>
        </div>
